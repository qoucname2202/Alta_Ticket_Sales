          ...
          <div className='flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left'>
            <div className='w-full md:w-1/2'>
              <div className='mb-10 lg:mb-20'>
                <img src='/images/logo.svg' alt='logo-alta' />
              </div>
              <div className='mb-10 md:mb-20 text-gray-600 font-light'>
                <h1 className='font-black uppercase text-4xl lg:text-5xl text-primary mb-10'>
                  Oops ? Page not found
                </h1>
              ...
              <div className='mb-20 md:mb-0'>
                <button
                  className='text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-primary hover:text-primary-600'
